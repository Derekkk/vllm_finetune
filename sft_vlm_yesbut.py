...
if __name__ == "__main__":
    ...
    # decision making
    # dataset = load_dataset("json", data_files={"train": "./data/textual_decision_making/GPT4o_situation_mcq_v2_train_trainable.jsonl", "test": "./data/textual_decision_making/GPT4o_situation_mcq_v2_dev_trainable.jsonl"}, cache_dir="/data/huzhe/hf_cache")

    # yesbut
    dataset = load_dataset("json", data_files={"train": "./data/yesbut_v2/GPT4o_yesbut_moral_train_trainable.jsonl", "test": "./data/yesbut_v2/GPT4o_yesbut_moral_dev_trainable.jsonl"}, cache_dir="/data/huzhe/hf_cache")
